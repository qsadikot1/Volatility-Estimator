...
This project was built from scratch to understand how **quantitative finance measures market risk** and why different volatility models exist.
...
Volatility was then treated as **time-varying risk**, not a constant value.
...
* **20-day rolling volatility**
  ...
  Because each observation carries significant weight, it is well suited for **short-term risk estimation**, where responsiveness to recent shocks is more important than smoothness.

* **60-day rolling volatility**
  Smooths out short-term noise while still responding to changes in market conditions.
  This window represents a **medium-term view of risk**, balancing stability and responsiveness.

* **120-day rolling volatility**
  Uses roughly six months of data and assumes risk evolves slowly over time.
...
* Long windows are stable but lag market shocks
* EWMA provides a compromise between speed and smoothness

During periods of market stress (such as the 2020 COVID crash), these differences become especially clear and illustrate **volatility clustering**.

---

## Relationship Between Volatility and Price
...
Plotting price alongside volatility highlights the relationship between **large price movements and elevated risk**.
Periods of sharp price declines are often accompanied by spikes in volatility, reflecting increased uncertainty and market stress.

During major drawdowns (e.g. the 2020 COVID crash), the price chart shows rapid declines while volatility rises sharply, reinforcing the idea that volatility captures the **intensity of market movements**, not their direction.
...
* No single volatility estimator is optimal in all situations
